class GenericAttachment(object):
    def __init__(self, alias=None, compression=None):
        self.alias = alias
...
class File(GenericAttachment):
    def __init__(self, file_path, alias=None, compression=None):
        super().__init__(alias, compression)
        self.f_path = file_path


class Directory(GenericAttachment):
    def __init__(self, directory_path, alias=None, compression=None):
        super().__init__(alias, compression)
        self.d_path = directory_path


class Command(GenericAttachment):
    def __init__(self, cmdline, alias=None, compression=None):
        super().__init__(alias, compression)
        self.cmdline = cmdline


class CycleCommand(Command):
    def __init__(self, cmd_for_list, cmdline, alias=None, compression=None):
        super().__init__(alias, compression)
